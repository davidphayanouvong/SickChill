                ...
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <div class="component-group-desc">
                        ...
                        % if not sickbeard.USE_NZBS or not sickbeard.USE_TORRENTS:
                            <blockquote style="margin: 20px 0;">NZB/DLL/${_('Torrent and NZB providers can be toggled in ')}
                                ...
                                <%
                                    ...
                                    for curProvider in sickbeard.providers.sortedProviderList():
                                        if curProvider.provider_type == GenericProvider.NZB and not (sickbeard.USE_NZBS and curProvider.is_enabled):
                                            ...
                                            continue
                                        elif curProvider.provider_type == GenericProvider.DDL and not (sickbeard.USE_DDLS and curProvider.is_enabled):
                                            continue
